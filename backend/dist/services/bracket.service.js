...
exports.generateSingleEliminationBracket = void 0;
...
const generateSingleEliminationBracket = async (tournamentId) => {
    ...
    const matchesAccumulator = [];
    // Recursive function to build tree
    const buildTree = (round, startIndex, endIndex) => {
        ...
        const match = new match_model_1.default({
            ...
            player1: new mongoose_1.default.Types.ObjectId(),
            player2: new mongoose_1.default.Types.ObjectId(),
        });
        const node = {
    ...
    await match_model_1.default.insertMany(matchesAccumulator);
    // Update tournament
...
exports.generateSingleEliminationBracket = generateSingleEliminationBracket;
