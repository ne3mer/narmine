...
exports.getAllProductTemplates = getAllProductTemplates;
exports.getTemplateField = getTemplateField;
exports.productTemplates = {
    // بازی دیجیتال (فعلی)
    digital_game: {
        id: 'digital_game',
        name: 'بازی دیجیتال',
...
function getProductTemplate(productType) {
    return exports.productTemplates[productType] || null;
}
// Get all templates as array
function getAllProductTemplates() {
    return Object.values(exports.productTemplates);
}
// Get template field by name
function getTemplateField(productType, fieldName) {
    const template = getProductTemplate(productType);
    if (!template)
        return null;
    return template.fields.find(f => f.name === fieldName) || null;
}
//# sourceMappingURL=productTemplates.js.map