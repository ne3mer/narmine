...
const gameRequestService = __importStar(require("../services/gameRequest.service"));
...
const getAllGameRequests = async (req, res) => {
    ...
    const result = await gameRequestService.getAllGameRequests(status);
    res.json(result);
};
...
//# sourceMappingURL=gameRequest.controller.js.map