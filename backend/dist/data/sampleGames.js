...
exports.sampleGames = [
    {
        ...
        description: 'سرویس خواب دو نفره تمام چوب با طراحی کلاسیک و پارچه ضد لک، شامل تخت، دو پاتختی و میز آرایش.',
        genre: ['کلاسیک', 'چوبی'],
        platform: 'Bedding',
        regionOptions: ['IR'],
        basePrice: 25000000,
    ...
    },
    {
        ...
        description: 'تشک طبی فنری با الیاف ضد حساسیت و پارچه گردبافت، مناسب برای افرادی که کمردرد دارند.',
        genre: ['طبی', 'فنری'],
        platform: 'Mattress',
        regionOptions: ['IR'],
        basePrice: 8500000,
    ...
    },
    {
        ...
        description: 'بالش بسیار نرم و راحت پر شده با پر قو، با روکش نخی ضد تعریق.',
        genre: ['بالش', 'پر'],
        platform: 'Pillow',
        regionOptions: ['IR'],
        basePrice: 1200000,
    ...
    },
    {
        ...
        description: 'ست روتختی ۶ تکه شامل کاور لحاف، ملحفه و ۴ روبالشی، جنس ساتن پنبه.',
        genre: ['روتختی', 'ترک'],
        platform: 'Bedding',
        regionOptions: ['TR'],
        basePrice: 3800000,
