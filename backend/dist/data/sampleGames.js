...
exports.sampleGames = void 0;
exports.sampleGames = [
    {
        title: 'God of War Ragnarök',
        slug: 'god-of-war-ragnarok',
        description: 'ماجراجویی جدید کریتوس و آترئوس با دوبله فارسی، مناسب برای طرفداران تجربه‌های داستانی ژانر اکشن.',
        genre: ['اکشن', 'داستانی'],
        platform: 'PS5',
        regionOptions: ['R2'],
        basePrice: 2899000,
    ...
    },
    {
        ...
        description: 'تجربه‌ای آزاد در نیویورک با امکان تعویض لحظه‌ای بین پیتر و مایلز به همراه پشتیبانی کامل GameClub.',
        genre: ['اکشن', 'جهان‌باز'],
        platform: 'PS5',
        regionOptions: ['TR'],
        basePrice: 2599000,
    ...
    },
    {
        ...
        description: 'آخرین نسخه سری فوتبال الکترونیک با تمرکز روی تجربه آنلاین Ultimate Team و تورنمنت‌های داخلی.',
        genre: ['ورزشی', 'رقابتی'],
        platform: 'PS5',
        regionOptions: ['TR'],
        basePrice: 1999000,
    ...
    },
    {
        ...
        description: 'ترکیب نسخه کامل بازی به همراه DLC Shadow of the Erdtree به همراه راهنمای فارسی و پشتیبانی ۲۴ ساعته.',
...
//# sourceMappingURL=sampleGames.js.map