...
exports.defaultMarketingSettings = void 0;
exports.defaultMarketingSettings = {
    bannerContent: {
        title: 'Game Club Banner 1403',
        subtitle: 'Creative Drop',
        badge: 'تحویل ۳۰ ثانیه‌ای',
        description: 'با عضویت در Game Club می‌توانید هر ماه ۳ اکانت Safe را با قیمت ویژه دریافت کنید و در اولویت پشتیبانی تلگرام قرار بگیرید. این بنر تعاملی وسط صفحات کاتالوگ/اکانت طراحی شده تا تبدیل را افزایش دهد.',
...
//# sourceMappingURL=marketingDefaults.js.map