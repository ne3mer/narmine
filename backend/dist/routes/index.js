...
const game_request_route_1 = __importDefault(require("./game-request.route"));
const tournament_route_1 = __importDefault(require("./tournament.route"));
const arena_upload_route_1 = __importDefault(require("./arena-upload.route"));
const match_route_1 = __importDefault(require("./match.route"));
const bracket_route_1 = __importDefault(require("./bracket.route"));
...
router.use("/game-requests", game_request_route_1.default);
router.use("/arena/tournaments", tournament_route_1.default);
router.use("/arena/upload", arena_upload_route_1.default);
router.use("/arena/matches", match_route_1.default);
router.use("/arena/brackets", bracket_route_1.default);
router.use("/arena/disputes", dispute_route_1.default);
router.use("/arena/payouts", payout_route_1.default);
